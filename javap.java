...
class GetMyIPAddress {
    public static void main(String args[]) throws Exception {
        ...
        InetAddress ubuntuIP= InetAddress.getByName("ubuntu-1");
        /*InetAddress myIP = InetAddress.getByName("ubuntu-2");
        /* public String getHostAddress(): Returns the IP
         * address string in textual presentation.
         */
        System.out.println("My IP Address is:");
        System.out.println(myIP.getHostAddress());
        System.out.println("My ubuntu-1 IP Address is:");
        System.out.println(ubuntuIP.getHostAddress());
    }
}
